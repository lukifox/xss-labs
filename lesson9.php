<?php
if(empty($_GET['file'])){
header('Location:'.$_SERVER['PHP_SELF'].'?'.'file=logo.jpg');
}else{echo "";}
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="main">
  ...
  <div class="data">
    ...
    <center><img src='<?php echo htmlspecialchars($_GET['file']); ?>' height=230 width=230 alt="ဖုန် ရှူ လိုက်" /></center>
    <br><br><br>
    <h2>Title: <b class='g'>Can you exploit me?</b> </h2>
    <br><br><br><br><br><br>
